...
public class HomeActivity extends AppCompatActivity {
    ...
    private CardView card_comingsoon;
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        card_comingsoon = findViewById(R.id.cardComingSoon);
        ...
        // Untuk pindah ke ComingSoon
        card_comingsoon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
